...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "3d8ecee8-a474-4b32-a048-d77c13b78d5d");
  ...
  return (
    ...
    >
      ...
      <motion.form
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ daration: 0.5, delay: 0.9 }}
        onSubmit={onSubmit}
      ...
      >
        <div className="grid grid-cols-auto gap-6 mt-10 mb-8">
          <motion.input
            ...
            transition={{ daration: 0.6, delay: 1.1 }}
            type="text"
        ...
        <motion.textarea
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ daration: 0.6, delay: 1.3 }}
          rows="6"
